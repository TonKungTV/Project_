...
const HomeScreen = ({ navigation }) => {
    ...
    // โหมดของโมดัล: 'record' | 'detail' | 'edit'
    ...
    const saveEdits = async () => {
        ...
        try {
            const actualTimeNormalized = normalizeTime(actualTakeTime);
            const updateData = {
            ...
            await load();
            closeModal(); // เรียกใช้ closeModal แทนการตั้งค่าทีละอย่าง
                        ...
                        {selectedItem && (
                            <>
                                ...
                                <View style={styles.inputSection}>
                                    ...
                                    <TouchableOpacity style={styles.timeSelector} onPress={isEditable ? showTimePickerModal : null}>
                                ...
                                {modalMode === 'record' && (
                                    <View style={styles.modalButtonRow}>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() => toggleStatus(selectedItem, sideEffects, actualTakeTime, 'ข้าม')}
                                        >
                                ...
                                {modalMode === 'edit' && (
                                    // โหมดแก้ไขรายละเอียด: บันทึกการเปลี่ยนแปลง/ยกเลิก
                                    <View style={styles.modalButtonRow}>
                                        <TouchableOpacity
